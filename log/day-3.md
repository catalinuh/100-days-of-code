...
I'm getting a late start on Day 3 but I'm having such a busy weekend! Today, I'm only coding in markdown haha. I want to reorganize these logs and split each log for each day into separate files so I can link to each one from my GitHub profile's README.md. At the moment, if all the logs are on the same page and I want to link to different sections, GitHub redirects the link to the top of the page instead of to the exact entry. So I'm hoping this fixes the issue!
